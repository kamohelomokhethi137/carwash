      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {/* Sign In Button */}
            <motion.button
              whileHover={{ scale: 1.05, boxShadow: '0 0 8px rgba(99, 102, 241, 0.6)' }}
              whileTap={{ scale: 0.95 }}
              className="px-4 py-2 rounded-md bg-gradient-to-r from-[#a3bffa] to-[#c3dafe] text-[#1a202c] text-sm font-medium shadow-md transition-all duration-300 cursor-pointer"
        ...
        {isOpen && (
          ...
          >
            <div className="px-2 pt-2 pb-4 space-y-2 sm:px-3">
              {navItems.map((item, index) => (
                item.href.startsWith('/') ? (
                  <MotionLink
                    key={item.name}
                    to={item.href}
                    className={`flex items-center px-3 py-3 rounded-md text-base font-medium cursor-pointer ${
                      activeLink === item.name
              ...
              <motion.button
                className="w-full mt-2 px-4 py-3 rounded-md bg-gradient-to-r from-[#a3bffa] to-[#c3dafe] text-[#1a202c] font-medium shadow-md cursor-pointer"
